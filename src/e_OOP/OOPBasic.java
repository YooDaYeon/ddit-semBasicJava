...
public class OOPBasic {
	public static void main(String[] args) {
		...
		4. 선언 위치에 따른 변수의 종류
		  ...
		  - 인스턴스변수
		    ...
		    : 인스턴스는 독립적인 저장공간을 가지므로 서로다른 값을 가질 수 있다.
		      그럼으로 인스턴스마다 고유한 상태를 유지해야하는 속성의 경우 인스턴스변수로 선언한다.
		...
		5. 메서드
		 ...
		 11. 클레스멤버와 인스턴스 멤버간의 참조와 호출
		   - 같은 클래스의 멤버간에는 객체 생성이나 참조변수 업이 참조할 수 있다.
		   - 클래스멤버 에서는 인스턴스 멤버를 호출할 수 없다.
		 ...
		 14. 생성자
		   ...
		   - 특징
		     : 메서드처럼 클래스 내에 선언된다.
		     : 리턴값이 없다.
		       (생성자도 메서드 이기 때문에 리턴값이 없는 void를 적어야 하지만
