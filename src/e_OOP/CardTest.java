...
public class CardTest {
	public static void main(String[] args) {
		...
		//11. 아래와 같이 출력해주세요
		//   cd1의 모양은 xx이고 숫자는 xx이고 너비는 xx이고 높이는 xx이다.
		System.out.println("cd1의 모양은" + cd1.kind + "이고 숫자는" + cd1.number + "이고 너비는" + cd1.width + "높이는"+cd1.height+"이다.");
		//   cd2의 모양은 xx이고 숫자는 xx이고 너비는 xx이고 높이는 xx이다.
		System.out.println("cd2의 모양은 "+ cd2.kind + "이고 숫자는 " + cd2.number + "이고 너비는 " + cd2.width + "높이는 "+cd2.height+"이다.");
...
class Card{
	//1. 카드의 너비를 저장할수 있는 클래스변수 width를 선언하고 100의 값으로 초기화 하세요 
	static int width =100;
	//2. 카드의 높이를 저장할수 있는 클래스변수 height를 선언하고 250의 값으로 초기화 하세요
	static int height = 250;
	//3. 카드의 종류를 저장할수 있는 인스턴스변수 kind를 선언해주세요
	String kind;
	//4. 카드의 번호를 저장할수 있는 인스턴스변수 number를 선언해주세요
	int number;
	void method(){
		int v = 3; //지역변수
	}
